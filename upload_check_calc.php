...
if ( (int)$nextcalc = 1 ) { $newcode = (int)file_get_contents('code/code.txt') + 5; $newcalc = 2; }
elseif ( (int)$nextcalc = 2 ) { $newcode = (int)file_get_contents('code/code.txt') * 1.2; $newcalc = 3; }
elseif ( (int)$nextcalc = 3 ) { $newcode = (int)file_get_contents('code/code.txt') + 4; $newcalc = 4; }
elseif ( (int)$nextcalc = 4 ) { $newcode = (int)file_get_contents('code/code.txt') + 1; $newcalc = 1; };
